...
public class RNWebrtcNotificationHelper {
    ...
    public void sendCallNotification(ReadableMap jsonObject){
        if(jsonObject.getBoolean("ringtuneSound") == true){
            RNWebrtcRingtunePlayer.getInstance(context).playMusic(jsonObject);
        }
    ...
    public void sendNotification(ReadableMap json){
        ...
        Intent dissmissIntent = new Intent(context, RNWebrtcBroadcastReciever.class);
